...
using AriProject.Application.Orders.ChangeCustomerOrder;
using AriProject.Application.Orders.GetCustomerOrderDetails;
using AriProject.Application.Orders.GetCustomerOrders;
using AriProject.Application.Orders.PlaceCustomerOrder;
using AriProject.Application.Orders.RemoveCustomerOrder;
